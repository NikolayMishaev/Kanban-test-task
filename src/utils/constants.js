const DATA_BOARDS = [
  {
    ...
    cards: [
      ...
      },
      {
        id: 'BC–11',
        title: 'Задача № 3',
        description: 'Добавить возможность добавления задачи в конец при перетаскивании',
        storyPoints: 2,
        priority: 'unkown',
      },
      {
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        id: 'MAR-13',
        title: 'Задача № 9',
        description: 'Создать стейт для хлебных крошек, передавать текущий путь',
        storyPoints: 3,
        priority: 'major',
      },
    ],
  },
  {
    ...
    cards: [
      ...
      },
      {
        id: 'MAR-20',
        title: 'Задача № 12',
        description: 'Временной решение с уникальным айди, найти библиотеку с генерацией уникальных ключей',
        storyPoints: 4,
        priority: 'major',
      },
      {
